...
// ---------------------------------------------------------
  ...
  int innerTurnSpeed = turnSpeed * 0.9;  // سرعة الانعطاف التفاضلية للعجل الداخلي
...
int S_White[12] = {188, 167, 176, 174, 213, 185, 188, 169, 170, 216, 346, 201};
int S_Black[12] = {2471, 2445, 2426, 2440, 3235, 3084, 2786, 2482, 2797, 3300, 3885, 3018};
int target_White = 186;
int target_Black = 2819;
int lineThreshold = 1503;
